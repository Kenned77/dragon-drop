...
var pieces = [ // index 0 legal move, index 1 the piece
            [
              [101], [0] // square small.
            ],
            [
...
function testing() {
  ...
  if (startNum >= pieces[typeTest][0][pieces[typeTest][0].length - 1]) {
    ...
    for ( var i = 0; i < pieces[typeTest][0].length; i++ ) {
      if (startNum === pieces[typeTest][0][i]) {
        console.log(pieces[typeTest][0][i]);
        inFrame = false;
        console.log('nope cant do!');
      }
    }
  ...
  // console.log(pieces[typeTest][0].length);
  // console.log(pieces[typeTest][0][pieces[typeTest][0].length - 1]);
  // console.log(pieces[typeTest][0].length);
